      ...
      <div className="card animate-in" style={{ marginBottom: '2rem' }}>
        ...
        <div className="grid-4">
          <div style={{ textAlign: 'center' }}>
            <div style={{ fontSize: '1.6rem', fontFamily: 'var(--mono)', fontWeight: 700, color: 'var(--primary)' }}>{currentRatio}</div>
            <div style={{ fontSize: '0.7rem', color: 'var(--text-muted)', textTransform: 'uppercase', marginTop: 4 }}>Current Ratio</div>
            <div style={{ fontSize: '0.7rem', color: 'var(--text-muted)' }}>Liquidità Corrente</div>
          </div>
          <div style={{ textAlign: 'center' }}>
            <div style={{ fontSize: '1.6rem', fontFamily: 'var(--mono)', fontWeight: 700, color: 'var(--accent)' }}>{quickRatio}</div>
            <div style={{ fontSize: '0.7rem', color: 'var(--text-muted)', textTransform: 'uppercase', marginTop: 4 }}>Quick Ratio</div>
            <div style={{ fontSize: '0.7rem', color: 'var(--text-muted)' }}>Liquidità Secca</div>
          </div>
          <div style={{ textAlign: 'center' }}>
            <div style={{ fontSize: '1.6rem', fontFamily: 'var(--mono)', fontWeight: 700, color: 'var(--purple)' }}>{debtEquity}</div>
            <div style={{ fontSize: '0.7rem', color: 'var(--text-muted)', textTransform: 'uppercase', marginTop: 4 }}>Debt / Equity</div>
            <div style={{ fontSize: '0.7rem', color: 'var(--text-muted)' }}>Leva Finanziaria</div>
          </div>
          <div style={{ textAlign: 'center' }}>
            <div style={{ fontSize: '1.6rem', fontFamily: 'var(--mono)', fontWeight: 700, color: 'var(--success)' }}>{solidita}%</div>
            <div style={{ fontSize: '0.7rem', color: 'var(--text-muted)', textTransform: 'uppercase', marginTop: 4 }}>Solidità</div>
            <div style={{ fontSize: '0.7rem', color: 'var(--text-muted)' }}>PN / Totale Fonti</div>
          </div>
        </div>
      </div>

...
import {
  ...
  Minus, DollarSign, Percent, RefreshCw,
} from 'lucide-react';
      ...
      <div className="page-header">
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '1rem' }}>
          <div>
            ...
            <p style={{ marginTop: 6 }}>
              Riclassificazione a Valore della Produzione — Schema ex art. 2425 c.c.
            </p>
          </div>
      ...
      <div className="grid-2" style={{ alignItems: 'start', gap: '2rem' }}>
        <div>
          <div className="section-divider" style={{ marginBottom: '1rem' }}>
            <div
              ...
              style={{ background: 'rgba(15,212,148,0.12)', border: '1px solid rgba(15,212,148,0.22)' }}
            >
              <ArrowUpRight size={17} color="var(--success)" />
            </div>
            <h2 className="section-divider-title">A — VALORE DELLA PRODUZIONE</h2>
        ...
        <div>
          <div className="section-divider" style={{ marginBottom: '1rem' }}>
            <div
              className="section-divider-icon"
              style={{ background: 'rgba(255,77,106,0.12)', border: '1px solid rgba(255,77,106,0.22)' }}
            >
              <ArrowDownRight size={17} color="var(--danger)" />
            </div>
            <h2 className="section-divider-title">B — COSTI DELLA PRODUZIONE</h2>
            <div className="section-divider-line" />
          </div>
          ...
          <FieldGroup label="Costi del Personale" color="red" icon="👥" defaultOpen={false} subtotal={costiPersonale}>
            ...
            <Field label="Trattamento di Fine Rapporto"   {...f('tfr')} />
          ...
          <div style={{ marginTop: '1.5rem' }}>
            <div className="section-divider" style={{ marginBottom: '1rem' }}>
              <div
                className="section-divider-icon"
                style={{ background: 'rgba(255,179,64,0.12)', border: '1px solid rgba(255,179,64,0.22)' }}
              >
                <span style={{ fontSize: '0.8rem' }}>💳</span>
              </div>
              <h2 className="section-divider-title" style={{ fontSize: '0.85rem' }}>C — ONERI / PROVENTI FINANZIARI</h2>
              <div className="section-divider-line" />
            </div>
